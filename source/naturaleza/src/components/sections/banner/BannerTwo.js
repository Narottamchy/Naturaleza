            ...
            if (item.type === "small") {
              return (
                <Col xs={0} sm={0} md={8} key={index}>
                  ...
                  >
                    <Image priority={true} src={item.image} alt="Banner small item image" layout="fixed" width='100%' height='100%'/>
                  </div>
                </Col>
              );
            }
              ...
              <Col xs={24} sm={24} md={16} key={index}>
                ...
                >
                  <Row justify="center" align="middle">
                    <Col md={12}>
                      <Image priority={true} src={item.image} alt="Banner big item image" layout="fixed" width='100%' height='100%'/>
                    </Col>
                    <Col md={12}>
                      <h5>
